...
public class FoodOrder extends Order {
    public FoodOrder(double x, double y, Country country, int amount, int speed, Position target) {
        super(x, y);
    ...
    /***
     * In this method, we used the Graphics2D library to plot all Food Orders generated randomly if related country's citizen happiness drops below %50
    ...
    /***
     * This method is used to step up the FoodOrder
     * It checks its destination which is the FirstHorizontalLineY at the top. Since it is not catchable by any corporation
     * we don't check whether any corporation is around
     */
    ...
    public void step() {
        ...
        if (totalDistance < 8) {
            this.country.buyFood(this.amount);
            this.completed = true;
        } else {
    ...
    /***
     * It Creates a new instance of a FoodOrder by creating amount and speed of the order randomly.
     ...
     * @return It returns a new instance of a FoodOrder
     */
